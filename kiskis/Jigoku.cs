...
namespace StorybrewScripts
{
    ...
    public class Jigoku : StoryboardObjectGenerator
    {
        ...
        private void MakeNote(int time, double x, double y, double angle, double distance, int inTime, int outTime)
        {
            ...
            var note = spritePools.Get(t0, t3, "sb/particles/hl.png", OsbOrigin.Centre, true);
            ...
            var backNote = spritePools.Get(t1b, t4, "sb/particles/hl.png", OsbOrigin.Centre, true);
            ...
            var light = spritePools.Get(t2, t4, "sb/particles/light.png", OsbOrigin.CentreLeft, true);
