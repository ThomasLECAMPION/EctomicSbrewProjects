    ...
    {   
        ...
        {   
            ...
            for(int i=0; i<2; i++)
            {
                ...
                sprite.Fade(StartTime, 10591, 0, 0.35); sprite.Fade(10591, 0.4); sprite.Fade(1701048, 1705548, 0.4, 0);
        ...
        {   
            ...
            for(int i=1000; i<=totalTime/2; i++) //5000 because loops faster than 5000ms are way too fast, but feel free to lower it if you need
            {
